...
<br>
  ...
  一些属性现在可以针对每种材料定义，然后从模块和蓝图引用。
<br>
<br>

材料数据根据材料类型（例如木材、金属或皮肤）组织在不同的文件夹中，每种材料有一个文件/资源。然后，模块和蓝图可以引用特定的材料（例如木材/云杉或杂项/骨头）或某种类型的所有材料（例如木材或金属），并定义这些材料的属性应该如何应用于模块。
<br>
<br>
材料数据从data/tetra/materials/文件夹中加载。
</p>
<h2>Material</h2>
